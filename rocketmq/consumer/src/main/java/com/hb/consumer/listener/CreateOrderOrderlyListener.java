...
@RocketMQMessageListener(
        topic = RocketConstants.CREATE_ORDER_TOPIC,
        consumerGroup = RocketConstants.CREATE_ORDER_CONSUMER_GROUP,
        consumeMode = ConsumeMode.ORDERLY) // 有序
public class CreateOrderOrderlyListener implements RocketMQListener<String> {
